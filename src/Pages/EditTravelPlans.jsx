...
const EditTravelPlan = ({ updateTravelPlanSubmit }) => {

    const Place = useLoaderData();
    const [group_size, setgroup_size] = useState(Place.group_size);
    const [id, setId] = useState(Place.id);
    const [name, setTravelBuddy] = useState(Place.name);
    const [preferred_destination, setpreferred_destination] = useState(Place.preferred_destination);
    const [destination_description, setdestination_description] = useState(Place.destination_description);
    const [availability, setAvailability] = useState(Place.availability);
    ...
    const submitForm = (e) => {
        ...
        updateTravelPlanSubmit(updatedPlace);
            ...
            <div className="container m-auto max-w-2xl py-24">
                <div className="bg-pink-100 px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                    <form onSubmit={submitForm}>
                        <h2 className="text-4xl text-center font-semibold mb-6 text-pink-500 ">Update Travel Plan!</h2>
